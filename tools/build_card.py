...
ROWS = [
    ...
    DIV,
    ("Previously:", BLUE, [B("Pharmacy robotics + remote dispensing"),
                           B("EHRs before SaaS was cool"),
                           B("Non-invasive blood glucose monitor"),
                           B("Construction tech")]),
    DIV,
    ("Side.Quests:", GREEN, [J("General Aviation", "Handbuilt Race Cars"),
...
FOOT_INDENT = 100              # inset of the footer panels
